...
// +kubebuilder:rbac:groups=core,resources=namespaces,verbs=get;list;watch;delete;create;update
// +kubebuilder:rbac:groups=apps,resources=deployments,verbs=get;list;watch;delete;create;update
// +kubebuilder:rbac:groups=core,resources=services;endpoints;pods;nodes,verbs=get;list;watch
...
// +kubebuilder:rbac:groups=core,namespace=external-dns-operator,resources=secrets;serviceaccounts,verbs=get;list;watch;delete;create;update
// +kubebuilder:rbac:groups=core,namespace=external-dns,resources=secrets;serviceaccounts,verbs=get;list;watch;delete;create;update
