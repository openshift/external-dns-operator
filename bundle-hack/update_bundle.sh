...
# https://gitlab.cee.redhat.com/cpaas-midstream/external-dns-operator/-/blob/ext-dns-optr-1.1-rhel-8/distgit/containers/external-dns-operator-bundle/render_templates?ref_type=heads
set -x
set -e
